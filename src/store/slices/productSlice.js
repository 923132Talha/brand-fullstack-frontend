...
export const updateProduct = createAsyncThunk("products/updateproduct", async ({ productId, updatedProduct }) => {
    const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/products/${productId}`, updatedProduct); // Use PUT for update
    return response.data;
});

// Delete a product
export const deleteProduct = createAsyncThunk("products/deleteproduct", async (id) => {
    const response = await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/products/${id}`,{withCredentials:true});
    return response.data;
});
